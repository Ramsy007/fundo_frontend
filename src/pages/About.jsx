        ...
        <div className="bg-white pb-15 rounded-b-[50px]">
          ...
          <div className="bg-black w-full min-h-screen flex flex-col">
            <div className="bg-white flex-1 min-h-screen px-2 sm:px-4 md:px-12 py-4 sm:py-6">
              {/* Hero Section */}
              <div
                className="relative bg-white rounded-[1.5rem] sm:rounded-[2rem] md:rounded-[3rem] shadow-lg overflow-visible my-2 sm:my-4 md:my-8 z-10 min-h-[250px] sm:min-h-[350px] md:min-h-[500px]   mx-auto"
                // data-aos="fade-up"
              >
                <div className="relative flex flex-col md:flex-row items-center justify-between px-2 sm:px-4 md:px-8 py-4 sm:py-8 md:py-12 bg-[#003049] rounded-[1.5rem] sm:rounded-[2rem] md:rounded-[3rem] min-h-[250px] sm:min-h-[350px] md:min-h-[500px] z-20">
                  {/* Mobile Hero Image - Only visible on small screens */}
                  <div className="md:hidden w-full flex justify-center mb-0.5">
                    <img
                      src="/Aboutchar1.png"
                      alt="Fundo Baba Hero"
                  ...
                  <div
                    className="hidden md:flex absolute top-[45%] right-[-120px] max-[1100px]:right-[-5px] max-[1100px]:top-[70%] -translate-y-1/2 h-[550px] w-auto items-center justify-end z-30 pointer-events-none"
                    // data-aos="zoom-in"
                  >
                    <img
                      src="/Aboutchar1.png"
                      alt="Fundo Baba Hero"
                      className="h-full max-[1100px]:h-[350px] w-auto object-contain drop-shadow-2xl"
                    />
                  </div>
                </div>
              </div>
