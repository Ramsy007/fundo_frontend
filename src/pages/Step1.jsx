      ...
      <div className="flex flex-1 items-center justify-center relative">
        ...
        >
          ...
          <div className="text-center mb-6">
            <h2 className="text-xl font-bold text-[#222] mb-1">Step into Baba's zone. Quick PAN. Faster Loan.</h2>
          ...
          <form className="w-full flex flex-col gap-4">
            ...
            <div className="flex items-center text-xs mt-1">
              ...
              <label htmlFor="terms" className="text-[#b48b8b]">
            ...
            >
              SUBMIT <span className="bg-white text-[#971201] rounded-full p-1 ml-1"><svg width="18" height="18" fill="currentColor" viewBox="0 0 20 20"><path d="M6 4l8 6-8 6V4z" /></svg></span>
            </button>
          </form>
        </motion.div>
