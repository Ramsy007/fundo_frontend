  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-[#a11b0a] ml-6 mr-6 rounded-b-lg">
      ...
      <div className="flex flex-1 items-center justify-center relative">
        ...
        {/* Center: Email Form Card with motion */}
        <motion.div
        ...
        >
          ...
          <div className="text-center mb-6">
            <h2 className="text-xl font-bold text-[#222] mb-1">Where Baba sends blessings (and OTPs).</h2>
          </div>
          ...
          <form className="w-full flex flex-col items-center gap-4">
            ...
            <h2 className="text-xl font-bold text-[#222] mb-1">Where your boss might say yes to your loan.</h2>
            <input
              type="email"
            ...
            <button
              type="submit"
              className="mt-4 w-[160px] mx-auto flex items-center justify-center gap-2 bg-[#971201] text-white font-bold py-2 rounded-full text-lg shadow hover:bg-[#b13a2f] transition"
            >
